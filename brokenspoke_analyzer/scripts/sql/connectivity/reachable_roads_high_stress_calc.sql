...
FROM PGR_DRIVINGDISTANCE(
    '
        ...
        WHERE  ST_DWithin(geom, (SELECT ST_Collect(v.geom) FROM generated.neighborhood_block_verts AS bv INNER JOIN neighborhood_ways_net_vert AS v ON v.vert_id = bv.vert_id WHERE bv.geoid20 = ''' || :block_id || '''), ' || :nb_max_trip_distance + 100 || ')
        UNION ALL
