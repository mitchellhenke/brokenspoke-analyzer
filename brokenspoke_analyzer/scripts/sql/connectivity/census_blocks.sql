...
ALTER TABLE neighborhood_census_blocks DROP COLUMN IF EXISTS libraries_low_stress;
ALTER TABLE neighborhood_census_blocks DROP COLUMN IF EXISTS libraries_high_stress;
ALTER TABLE neighborhood_census_blocks DROP COLUMN IF EXISTS libraries_score;
...
ALTER TABLE neighborhood_census_blocks ADD COLUMN libraries_low_stress INT;
ALTER TABLE neighborhood_census_blocks ADD COLUMN libraries_high_stress INT;
ALTER TABLE neighborhood_census_blocks ADD COLUMN libraries_score FLOAT;
