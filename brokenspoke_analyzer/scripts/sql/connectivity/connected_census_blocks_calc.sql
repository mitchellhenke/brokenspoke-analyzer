...
-- :nb_max_trip_distance, :nb_output_srid and :block_id psql vars must be set before running this script,
...
WHERE
    ST_Intersects(source.geom,neighborhood_boundary.geom) AND source.blockid10 = :block_id
